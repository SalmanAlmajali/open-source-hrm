...
use App\Filament\Resources\CashAccounts\Tables\CashAccountTable;
...
class CashAccountResource extends Resource
{
    ...
    protected static ?string $label = 'Rekening Kas';

    protected static ?string $pluralLabel = 'Rekening Kas';
    ...
    {
        return CashAccountTable::configure($table);
    }
